...
if ($statusSessions['size'] == '0') {
	...
	foreach ($statusSessions->Video as $sessions) {
		...
		if (isset($sessions['librarySectionID'])) {
			if ($sessions['type'] == "episode") {
				...
				echo "<div class='instance'>";
					echo "<div class='poster'>";
						echo "<div class='dashboard-activity-poster-face'><a href='info.php?id=" .$sessions['ratingKey']. "'><img src='includes/img.php?img=".urlencode($sessionsThumbUrl)."'></img></a></div>";
					...
					echo "<div class='dashboard-activity-button-info'>";
						echo "<button type='button' class='btn btn-warning' data-toggle='collapse' data-target='#infoDetails-".$sessions->Player['machineIdentifier']."'>";
			...
			if ($sessions['type'] == "episode") {
				echo "<div class='instance'>";
					echo "<div class='poster'>";
						echo "<div class='dashboard-activity-poster-face'><a href='" .$sessions['url']. "'><img src='includes/img.php?img=".urlencode($sessions['art'])."'></img></a></div>";
						echo "<div class='dashboard-activity-metadata-wrapper'>";
							echo "<div class='dashboard-activity-instance-overlay'>";
								echo "<div class='dashboard-activity-metadata-progress-minutes'>";
									$percentComplete = ($sessions['duration'] == 0 ? 0 : sprintf("%2d", ($sessions['viewOffset'] / $sessions['duration']) * 100));
	...
	foreach ($statusSessions->Track as $sessions) {
		if ($sessions['type'] == "track") {
			...
			echo "<div class='instance'>";
				echo "<div class='poster'>";
					echo "<div class='dashboard-activity-poster-face'><div class='art-music-face' style='background-image:url(includes/img.php?img=".urlencode($sessionsThumbUrl).")'></div></div>";
					echo "<div class='dashboard-activity-metadata-wrapper'>";
						echo "<div class='dashboard-activity-instance-overlay'>";
							echo "<div class='dashboard-activity-metadata-progress-minutes'>";
								$percentComplete = sprintf("%2d", ($sessions['viewOffset'] / $sessions['duration']) * 100);
